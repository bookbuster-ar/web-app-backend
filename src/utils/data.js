...
format: 
 [ { name: 'Nuevo', price: 7500 },
   ...
   { name: 'Alquiler', price: 1000 } ],
detail: 
 { synopsis: 'Este libro es una recopilación completa de la obra poética de Blanca Varela desde 1949 hasta 2000. Varela es una de las poetas más reconocidas de Perú y su obra es una exploración profunda y lúcida de la humanidad y la naturaleza.',
   price: 7500,
...
format: 
 [ { name: 'Nuevo', price: 5500 },
   { name: 'Alquiler', price: 1000 } ],
detail: 
 { synopsis: 'En este emotivo libro de poemas, Verónica Pérez Arango explora las profundidades de la noche y la soledad. Sus palabras nos transportan a un mundo donde nadie duerme de verdad y donde cada pensamiento cobra vida.',
   price: 5500,
...
format: 
 [ { name: 'Nuevo', price: 4500 },
   ...
   { name: 'Alquiler', price: 1000 } ],
detail: 
 { synopsis: 'Esta recopilación de poemas inéditos de Juana Bignozzi ofrece una mirada fresca a la última fase de su carrera. Estos poemas, llenos de fuerza y franqueza, demuestran la habilidad de Bignozzi para confrontar la realidad con valentía y autenticidad.',
   price: 4500,
...
author_nationality: 'Trinidad y Tobago',
...
format: 
 [ { name: 'Nuevo', price: 6290 },
   { name: 'Alquiler', price: 1000 } ],
detail: 
 { synopsis: 'Una colección de poesías que reflejan la juventud del autor y su perspectiva sobre la comunidad LGBTIQ. Mariano Blatt explora temas de identidad, amor y libertad en esta conmovedora antología de sus primeros trabajos poéticos.',
   price: 6290,
   subgenre: [ 'LGBTIQ' ],
   editorial: 'Blatt & Ríos',
   genre: 'Poesía',
...
author_nationality: 'Haití',
publication_year: 2014,
genre: 'Relatos Breves',
format: 
 [ { name: 'Nuevo', price: 2990 },
   { name: 'Usado', price: 2392 },
   { name: 'Alquiler', price: 1000 } ],
detail: 
 { synopsis: 'La protagonista de esta historia no entiende a sus dos hermanas mayores, que la tratan como si fuera una perfecta nulidad; ni a su madre, una señora propensa a las conductas explosivas; ni a su hermano pequeño, que vive abismado en las honduras de sí mismo...',
   price: 2990,
   subgenre: 
    [ 'Biografía',
      'Novela Breve',
...
detail: 
 { synopsis: 'Hebe Uhart (Moreno, Provincia de Buenos Aires, 1936 – Buenos Aires, 2018) ha llevado una vida escribiendo y publicando, desarrollando una obra que es un modo de mirar, de ser y estar en el mundo. La suya es una escritura que se abre al asombro por los misterios del mundo, de las relaciones, de lo que crece o decae, de lo que muda.Este volumen forma parte de un conjunto de tres libros con la obra completa de Hebe Uhart. Al de novelas (ya publicado) y cuentos, le seguirán las crónicas. La presente edición incluye todos sus volúmenes de cuentos: ‘Primeros cuentos’, ‘El budín esponjoso’, ‘La luz de un nuevo día’, ‘Guiando la hiedra’, ‘Del cielo a casa’, ‘Turistas’, ‘Un día cualquiera’ y otros cuentos dispersos y breves. En su narrativa no hay solemnidad ni simpleza, sino una inteligencia penetrante, aguda, sin sarcasmo, nunca condescendiente pero sí bañada de comprensión y gentileza. Esa exploración a fondo de la propia historia, de la familia y los vínculos más cercanos, es también la de la relación con los objetos y las actividades cotidianas. Su narrativa además se abre a otras zonas de la experiencia: los trabajos, la vida social, las discusiones sobre temas diversos, las relaciones amistosas o de pareja, el vínculo con el reino vegetal y animal, las rutinas domésticas y los viajes.',
   ...
   language: 'español',
   size: '22 x 16 cm' },
author_nationality: 'República Dominicana' },
...
detail: 
 { synopsis: 'Las cartas que Vincent van Gogh le escribió a su hermano Theo desde 1872 en adelante constituyen una fuente biográfica única e invalorable para conocer los objetivos, pasiones, esperanzas y desilusiones del pintor. Son un testimonio vivido, casi al modo de un diario, en el que el gran artista da cuenta de su cotidianeidad así como de su inestable salud física y mental. Después de haber inspirado biografías, películas, obras de teatro, documentales, estudios académicos y miniseries televisivas, estas cartas extraordinarias y conmovedoras se han transformado, a través de los años, en un grito desgarrado frente a la vida, en una utopía sobre la comunidad de artistas, en un gran documento humano en el que también se percibe la evolución pictórica del artista, enmarcada en la progresión dramática que va tomando la correspondencia.',
   ...
   language: 'español',
   size: '15 x 22 cm' },
author_nationality: 'El Salvador' },
...
format: 
 [ { name: 'Nuevo', price: 4500 },
   { name: 'Usado', price: 3600 },
   { name: 'Audiolibro', price: 1711 },
   { name: 'Digital', price: 3150 },
   { name: 'Alquiler', price: 1000 } ],
detail: 
...
format: 
 [ { name: 'Nuevo', price: 5690 },
   { name: 'Usado', price: 4552 },
   { name: 'Audiolibro', price: 3501 } ],
detail: 
 { synopsis: 'La ciencia de las (buenas) ideas es un libro escrito por Diego Golombek, doctor en Biología, profesor y divulgador científico argentino. En este libro, Golombek explora el mundo de las ideas y cómo la ciencia puede ayudarnos a entender su origen y cómo podemos fomentarlas. El libro busca desmitificar las ideas preconcebidas acerca de la innovación y explicar cómo impulsar la creatividad y el pensamiento innovador.',
   price: 5690,
   subgenre: [],
   editorial: 'Siglo XII',
   genre: 'Ciencia',
...
title: '¡Denuncia! El activismo de la queja frente a la violencia institucional',
author: 'Sara Ahmed',
publication_year: 2022,
genre: 'Pensamientos y Filosofía',
format: 
 [ { name: 'Nuevo', price: 7600 },
   { name: 'Usado', price: 6080 } ],
detail: 
 { synopsis: 'De un tiempo a esta parte, las denuncias se convirtieron en un componente tan central como polémico del feminismo y de la forma en que se organizan nuestras vidas políticas, profesionales y afectivas. En este libro, Sara Ahmed trabaja con episodios concretos de abuso en ámbitos universitarios, analizando el activismo de la queja como una forma de resistencia y transformación social.',
   price: 7600,
   subgenre: 
    [ 'Ensayo',
      'Feminismos',
...
detail: 
 { synopsis: 'Marsha Sprinkle es una ladrona de valijas, estafadora experimentada y maestra del disfraz que lleva una vida criminal exitosa en los suburbios de Baltimore. Hasta que un día, tras una serie de eventos desafortunados, el mundo parece decidido a hacerle pagar sus excesos. Ese es el punto de partida de Mentirosa, una road movie literaria sobre la odisea de una antiheroína en busca de venganza y libertad. Protagonista de una suerte de Bonnie & Clyde sin Clyde (o al menos hasta que un flechazo contaminado de Cupido la enfrenta por fin a un hombre digno en un baño), Marsha atraviesa la Costa Este de los Estados Unidos a bordo de limusinas, buses, aviones, ambulancias y todo medio de locomoción que se le cruce en el camino. Huye de la policía, pero sobre todo de una troupe desquiciada integrada por su hija –Poppy, la joven fundadora de un culto de saltarines fanáticos de las camas elásticas–, su madre –Adora, una excéntrica cirujana estética de mascotas de Nueva York– y su ex cómplice –Daryl, un perdedor heterosexual con un pene gay parlachín– que buscan con ansias asesinarla para erradicar la maldición que ha traído a sus vidas. Tal como sucedía con su trilogía ensayística (Mis modelos de conducta, Carsick y Consejos de un sabelotodo), el desembarco de Waters en el terreno de la ficción expresa con lucidez su destreza narrativa a través de un bestiario de criaturas enfurecidas y un sinfín de situaciones políticamente incorrectas. Lejos de los relatos de complicidad femenina y maternidades romantizadas, su primera novela (próxima a convertirse en película), escrita con hilarante rebeldía, se centra en una familia totalmente disfuncional y llena de odio que es la consecuencia de un país tan virulento como decadente. Es que Waters sabe más que nadie que la provocación es la mejor de las armas para hacer frente a una realidad cada vez más aburrida y pusilánime.',
   ...
   size: '14 x 22 cm',
   language: 'Español' },
author_nationality: 'Reino Unido' },
...
detail: 
 { synopsis: '¿Por qué, para qué y cómo escribe un periodista; de qué está hecha su vocación y qué es lo que le da sentido en estos tiempos? Zona de obras reúne columnas, conferencias y ensayos que la argentina Leila Guerriero hilvanó en torno a esas preguntas y que, publicados en diversos medios o leídos en encuentros literarios en América Latina y en España, se recogen por primera vez en un libro. El resultado es un mural en el que cada pieza apunta al corazón del oficio, lo ilumina y, al mismo tiempo, lo cuestiona: ¿cómo y cuándo nace la pulsión por escribir; de qué manera se alimenta; por qué vale la pena llevar un texto periodístico a su máximo potencial expresivo? Éste es un libro sobre la escritura de no ficción pero, también, sobre el cine, el cómic, las artes plásticas, la infancia, Madame Bovary, África, los padres y las lecturas, y respira, en cada una de sus páginas, la convicción de que el periodismo no es un género menor sino un género literario en sí mismo.',
   ...
   language: 'español' },
author_nationality: 'Puerto Rico' },
...
detail: 
 { synopsis: '¿Qué es el cambio climático? ¿Por qué debería preocuparnos el hábitat de los osos polares mientras podamos mantener nuestras rutinas cotidianas? La temperatura promedio de la Tierra subió 1,2 °C desde 1750. Parece poquito, una pavada. Pero fue suficiente para desencadenar una serie de modificaciones irreversibles en todo el mundo, con consecuencias devastadoras: incendios indomables, que pueden devorar desde Córdoba hasta California, desde Corrientes hasta Siberia o Australia; fenómenos climáticos extremos, como el huracán que en 2020 inundó el subterráneo de Nueva York; acidificación de los océanos que arrasa con numerosas especies. Este libro nos explica el abecé del gran tema de nuestro tiempo, a contrapelo de la inercia o la ceguera que nos hacen pensar que siempre hay algo más urgente. Marina Aizen, Pilar Assefh y Laura Rocha, periodistas de larguísima trayectoria en cuestiones ambientales, nos cuentan cómo empezó esta historia en el siglo XVIII y cómo se aceleró en las últimas décadas, qué cosa son los gases de efecto invernadero y por qué ponen en riesgo la vida humana y no humana, qué científicos alertaron sobre lo que pasaba y cómo operaron y operan el negacionismo y las fake news, qué peso tienen las pequeñas acciones individuales (reciclar biromes, plantar árboles, compostar) y qué responsabilidad cabe a los gobiernos para encarar esta crisis existencial. También nos invitan a aprovechar la ventana de oportunidad que todavía tenemos para replantearnos todo, desde qué producimos hasta cómo lo producimos, qué consumimos y en qué cantidad, cómo nos movemos y nos alimentamos, cómo administramos la transición hacia energías renovables. Entender de verdad la crisis climática supone dejar de verla como si fuera competencia de conservacionistas o fanáticos de bichos raros. (Re)calientes es un aporte imprescindible para que nuestro mundo al rojo vivo se convierta en un eje transversal de la agenda política y económica. Y es un llamamiento a dejar de procrastinar, porque la solución no vendrá de ninguna tecnología mágica, sino de lo que podamos generar nosotros.',
   ...
   language: 'Español' },
author_nationality: 'México' },
{ id: '1513cf1a-44a6-4f72-9c07-72ddfdf5f51a',
title: 'El poder de los afectos en la política hacia una revolución democrática y verde',
...
author: 'Javier Auyero, Sofia Servián',
publication_year: 2023,
genre: 'Pensamientos y filosofía',
format: 
...
detail: 
 { synopsis: 'En Cannabis, Chris Duvall explora la historia cultural y la geografía del cultivo más ampliamente distribuido de la humanidad y que suministra tanto cáñamo como marihuana. Este libro se centra en el producto más valioso de la planta en la actualidad, la droga psicoactiva marihuana, y al mismo tiempo ofrece una visión global de la planta, incluyendo regiones poco estudiadas como África y Australia. Cannabis es también la historia del cáñamo y su uso como fuente de fibra para cuerdas y textiles, semillas de cáñamo comestibles o aceite industrial para pinturas y combustible. El autor no defiende ni la prohibición ni la legalización de la droga, pero desafía los lugares comunes desde ambos lados del debate.',
   ...
   size: '21 cm. x 14.5 cm.',
   language: 'Español' },
author_nationality: 'Francia' } ];

// function addFormatToBooks(books) {
//   const newFormat = { name: 'Alquiler', price: 1000 };
//   const limit = Math.min(30, books.length); // En caso de que haya menos de 30 libros

//   for (let i = 0; i < limit; i++) {
//       books[i].format.push(newFormat);
//   }
//   return books;
// }


// const updatedData = addFormatToBooks(data);
// console.log(updatedData);


// function updateEpubToDigital(books) {
//   books.forEach(book => {
...
// // Uso
// const books = [
// // ... (aquí irían todos los libros que has proporcionado y cualquier otro que quieras incluir)
// ];

// const updatedBooks = updateEpubToDigital(data);
// console.log(updatedBooks);



// function setNationality(data) {
//   const halfLength = data.length / 2;

//   for (let i = 0; i < data.length; i++) {
//     if (i < halfLength) {
//       data[i].nationality_author = 'Latinoamericana';
//     } else {
//       data[i].nationality_author = 'Europea';
//     }
//   }
//   return data
// }

// console.log(setNationality(data));
