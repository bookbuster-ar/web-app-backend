...
const uploadBooks = async (bookDb) => {
  ...
  try {
    ...
    const usersData = [
      {name: "User1", last_name: "LastName1", email: "user1@email.com", is_inactive: false, is_blocked: false, subscription: true},
      {name: "User2", last_name: "LastName2", email: "user2@email.com", is_inactive: false, is_blocked: false, subscription: true},
      {name: "User3", last_name: "LastName3", email: "user3@email.com", is_inactive: false, is_blocked: false, subscription: true},
      {name: "User4", last_name: "LastName4", email: "user4@email.com", is_inactive: false, is_blocked: false, subscription: true}
    ];
